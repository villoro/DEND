...
log_oldest_task = PythonOperator(task_id="log_oldest", dag=dag, python_callable=log_oldest)
...
log_youngest = PythonOperator(task_id="log_youngest", dag=dag, python_callable=log_oldest)
...
create_youngest_task >> log_youngest
